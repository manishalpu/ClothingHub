    ...
    <body>
            ...
            <div class="col-sm-9 pt3">
                    ...
                    <div class="tab-content">
                            ...
                            <table class="table  table-responsive bold">
                                <tr class="warning">
                                    ...
                                    <?php
                                    $sql2 = "SELECT users.fullname as fname,users.phone1 as phone,appointment.*  from appointment join users on users.id=appointment.userid where appointment.doctorid='$id'";
