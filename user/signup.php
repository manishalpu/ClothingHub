...
<html>
    ...
    <body>
            ...
            <div class="col-sm-12 header">
                <h3 class="h3" style="color:white;">Home > User > Signup</h3>
            </div>
            <div class="col-md-3">
                            ...
                            <div class="col-sm-8">
                                <form action="new1.php" method="POST">
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <input class="form-control form-style" type="email" name="email1" placeholder="Enter Email">
                                        <br>
                                        <input class="form-control form-style" type="password" name="pass" placeholder="Enter Password">
                                        <br>
                                        
                                        <input class="form-control form-style" type="text" name="address" placeholder="Enter Address">
                                        <br>
                                ...
                                <br>
                                <h3 class="text-muted">Already Have A Account ?  <a href="login.php">Login</a></h3>
                            </div>
                        </div>
