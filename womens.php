<?php
    ...
    $sql1 = 'SELECT * FROM clothing WHERE (Gender = 2 or Gender = 3)';
    if(isset($_SESSION['femaleWhereFilter']) && $_SESSION['femaleWhereFilter'] != -1){
        $sql1 = $sql1.' and '.$_SESSION['femaleWhereFilter'];
        $_SESSION['femaleWhereFilter'] = -1;
    }
    ...
    <body>
            <nav class="navbar navbar-inverse">
                <div class="container-fluid">
                    ...
                    <ul class="nav navbar-nav" style="margin-left: 35%;">
                        ...
                        <li class="active"><a href="./womens.php"><b>Women</b></a></li>
            ...
            <nav class="navbar navbar-inverse">
                <div class="container-fluid">
                    ...
                    <form action="filterApplyWomen.php" method="POST">
            ...
            <div class="col-sm-12 text-center  health1" style="background:#2c3e50;" >
                <div clas="row">
                    ...
                    <div class="col-md-12">
                        <br><br>
                        <h3 class="text-muted h1" style="color:#fff;">Women's Collection</h3>
                        <?php 
                            if($noOfRow > 0){
                                while($clothSet = $resultSet -> fetch_assoc()){
                                    ...
                                    if($clothSet['Gender'] == 2){
                                        $clothUrl = "./img/Womens/$clothUrl";
                                    }
                                    else {
                                        $clothUrl = "./img/Mens/$clothUrl";
                                    }
                                    ...
                                    <div class=\"col-sm-4 text-center pt2\" >
                                        <div class=\"card\">
                                            <a href='SelectIdNextPage.php?id=$id'>
                                                <img src=\"$clothUrl\" style=\"width:auto;height:240;\" >
